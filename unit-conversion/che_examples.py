...
print(f"  {R_si} J/(mol·K) → psi·ft³/(lbmol·°R): {cheuc(R_si, 'J/(mol.K)', 'psi.ft3/(lbmol.degR)'):.4f} psi·ft³/(lbmol·°R)")
print("    Explanation: Gas constant in psi-cubic feet per pound-mole-Rankine")
